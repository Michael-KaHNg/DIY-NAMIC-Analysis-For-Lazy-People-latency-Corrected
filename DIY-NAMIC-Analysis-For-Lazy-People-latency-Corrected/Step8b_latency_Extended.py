...
def get_i_response_latency(i_df, start_array, end_array):
    ...
    for idx, start_time_stamp in enumerate(start_t_working):
        ...
        if str(end_code) in ['7540', '8540', '9540', '5521', 'Last_Trial']: # End code should already be a string, but I'm paranoid about that sort of thing. 
