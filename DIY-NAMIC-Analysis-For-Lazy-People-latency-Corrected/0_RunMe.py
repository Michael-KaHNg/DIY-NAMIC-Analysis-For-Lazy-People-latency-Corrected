...
print('---------------------------')
print('\n  This version of the program only calculates latency data for paradigms <P6-3>, <P6-6> and <P6-9>.')
print('\n  Latency calculation does not yet work for other paradigms.')
YesToLatency = input ('\n In addition, latency data with small analysis time window (e.g. 2 hrs) can cause errors.\n Do you also want to export latency data? (y/n).) )\n\n')
...
print('\n\n Thank you,  the analysis is completed! ') 
